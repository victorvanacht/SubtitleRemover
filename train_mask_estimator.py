...
def parse_args() -> argparse.Namespace:
	...
	parser.add_argument("--save-path", type=Path, default=Path(".\\artifacts\\mask_estimator_last.pt"), help="Path to save last checkpoint with optimizer state for resuming training.")
	parser.add_argument("--best-path", type=Path, default=Path(".\\artifacts\\mask_estimator_best.pt"), help="Path to save best checkpoint (lowest validation loss, no optimizer state).")
